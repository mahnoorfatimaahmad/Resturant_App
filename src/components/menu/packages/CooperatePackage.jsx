...
export const CorporateEventPackage = () => {
  ...
  return (
    <div className="flex  bg-gray-900/80 text-white w-[300px] sm:w-[400px] md:w-[500px] mt-[680px] flex-col rounded-2xl shadow-md items-center justify-center ">
      <h2 className="text-lg font-bold  bg-orange-600 mb-2 w-full text-white text-center py-2 px-4 rounded-t-lg">
        Corporate Event Package Offer
      </h2>
      <form
...
export default CorporateEventPackage;
